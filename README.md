...
```
┌─────────────────────────────────────────────────────────────────┐
│                   AI Agent 智能体容器 (集团/平台)                  │
│                                                                 │
│  ┌───────────────────────────────────────────────────────┐     │
│  │  容器运行时 (React Application)                        │     │
│  │  - 提供统一的 UI 框架                                   │     │
│  │  - 管理智能体生命周期                                   │     │
│  │  - 处理用户交互和路由                                   │     │
│  ├───────────────────────────────────────────────────────┤     │
│  │  @dev-to/react-loader (组件加载层)                     │     │
│  │  ├─ 加载远程组件 (开发环境: Vite Dev Server)           │     │
│  │  ├─ 加载远程组件 (生产环境: CDN/静态服务器)             │     │
│  │  └─ 支持开发/生产无缝切换                               │     │
│  └───────────────────────────────────────────────────────┘     │
│                           ▲                                     │
│                           │ HTTP(S)                             │
...
│ (本地开发)    │    │ (本地开发)    │    │ (本地开发)    │
├──────────────┤    ├──────────────┤    ├──────────────┤
│ Vite Dev     │    │ Vite Dev     │    │ Vite Dev     │
│ localhost:   │    │ localhost:   │    │ localhost:   │
│ 5173         │    │ 5174         │    │ 5175         │
├──────────────┤    ├──────────────┤    ├──────────────┤
│ @dev-to/     │    │ @dev-to/     │    │ @dev-to/     │
│ react-plugin │    │ react-plugin │    │ react-plugin │
│              │    │              │    │              │
│ 组件:         │    │ 组件:         │    │ 组件:         │
│ - 客服卡片    │    │ - 报表卡片    │    │ - 天气插件    │
│ - 订单卡片    │    │ - 审批卡片    │    │ - 日历插件    │
