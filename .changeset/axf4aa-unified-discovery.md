---
'@dev-to/react-shared': major
'@dev-to/react-plugin': major
'@dev-to/react-loader': major
'create-dev-to': patch
---

## Unified `__dev_to__` Discovery Endpoint - Major Refactoring
...
- All other STABLE_* constants point to new paths
